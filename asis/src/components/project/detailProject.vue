        ...
        <div class="row justify-between">
          <div class="col-12 col-sm-5 col-md-6">
            ...
            <q-card flat bordered class="q-pa-sm q-mb-md q-mt-md">
              <p class="q-mt-sm">
                Mesin yang digunakan: <span class="text-red">*</span>
              </p>
              <div class="col-md-11">
                <q-select
            ...
            >
              ...
              <q-card-action>
                <div class="q-pa-md">
                  <p>
                    Isi sejumlah satuan bahan yang digunakan (Meter atau Kg),
                  </p>
                </div>
              </q-card-action>
              <q-card-action>
          ...
          <div class="col-12 col-sm-5 col-md-5">
            <q-card v-if="p.statusProses === 'Proses'">
              ...
              <q-separator inset />
              <q-card-section>
                <q-list v-for="(a, i) in p.detOrder" :key="i" dense>
                  <q-input
                    :label="i"
                    v-model="p.detOrder[i]"
                    dense
                    :readonly="jns !== 'Input' && !editP"
                  />
                </q-list>
