    ...
    <div>
      ...
      <q-dialog v-model="adP">
        <q-card style="width: 700px; max-width: 80vw">
          ...
          <q-form @submit="inpUser(p)" @reset="onReset" class="q-gutter-md">
            <q-card-section>
      ...
      <q-dialog v-model="adU">
        <q-card>
          <q-card-section>
            <div class="text-h6">Akun {{ u.namaKaryawan }}</div>
          </q-card-section>
          <q-form @submit="inAkun(u)" @reset="onReset" class="q-gutter-md">
            <q-card-section>
              <q-input filled v-model="u.akun" label="Akun " lazy-rules dense />
              <q-select
                filled
                v-model="u.userType"
                :options="[
