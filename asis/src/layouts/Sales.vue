    ...
    >
      <q-list dense bordered padding class="rounded-borders text-white" separator>
          <q-expansion-item :content-inset-level="1">
            ...
            <q-item dense clickable tag="a" to="/sales/pricing">
              <q-item-section avatar>
            ...
            <q-item dense clickable tag="a" to="/sales/dataPO">
              <q-item-section avatar>
                <q-avatar rounded color="light-blue-13" text-color="white" icon="fas fa-gift"/>
              </q-item-section>
              <q-item-section>
                <q-item-label >Pesanan Pelanggan</q-item-label>
              </q-item-section>
            </q-item>
            <q-item dense clickable tag="a" to="/sales">
              <q-item-section avatar>
                <q-avatar rounded color="light-green-13" text-color="white" icon="fas fa-cart-plus"/>
              </q-item-section>
              <q-item-section>
                <q-item-label>Jual Barang</q-item-label>
                <q-item-label caption>Quotation & SO</q-item-label>
              </q-item-section>
            </q-item>
            <q-item dense clickable tag="a" to="/sales/dtPenjualan">
              <q-item-section avatar>
            ...
            <q-item dense clickable tag="a" to="/sales/stok">
              <q-item-section avatar>
            ...
            <q-item dense clickable tag="a" to="/sales/kongsi">
              <q-item-section avatar>
                <q-icon name="rss_feed" />
              </q-item-section>
              <q-item-section>
          ...
          <q-expansion-item :content-inset-level="1">
            <template v-slot:header>
              <q-item-section avatar>
                <q-avatar rounded color="pink-13" text-color="white" icon="fas fa-tools"/>
              </q-item-section>
              <q-item-section>
                Service Center
              </q-item-section>
            </template>
            <q-item dense clickable tag="a" to="/Sales/servis">
              <q-item-section avatar>
                <q-icon name="fas fa-tools" class="text-orange" />
              </q-item-section>
              <q-item-section>
          ...
          <q-expansion-item :content-inset-level="1">
            ...
            <q-item dense clickable tag="a" to="/sales/KasSales">
              <q-item-section avatar>
                <q-avatar rounded color="teal-13" text-color="white" icon="fas fa-hand-holding-usd"/>
              </q-item-section>
              <q-item-section>
            ...
            <q-item dense clickable tag="a" to="/sales/performa">
              <q-item-section avatar>
                <q-avatar rounded color="pink-13" text-color="white" icon="fas fa-chart-pie"/>
              </q-item-section>
              <q-item-section>
            ...
            <q-item dense clickable tag="a" to="/sales/piutang">
              <q-item-section avatar>
                <q-avatar rounded color="blue-13" text-color="white">P</q-avatar>
              </q-item-section>
              <q-item-section>
          ...
          <q-expansion-item :content-inset-level="1">
            ...
            <q-item dense clickable tag="a" to="/sales/partner">
              <q-item-section avatar>
