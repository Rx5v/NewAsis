    ...
    <q-form
      ...
      <q-table
        ...
        <template v-slot:top>
          <div class="col-xs-12">
            <q-toolbar>
              <div class="col-2 q-table__title">Jurnal Umum</div>
              <q-space/>
              <q-btn
                flat round dense
                icon="add_circle"
...
<script>
import { accRek, injurnal, dtPartner } from '../../services/apiList'
export default {
  data: () => ({
    valid: true,
    inRul: [ v => !!v || 'Isi data' ],
  ...
  methods: {
    ...
    async simpan () {
      console.log(this.detJur)
      if (this.detJur.length > 0 && this.detJur.every(a => (a.nilai !== 0 && a.kodeAkun !== null)) && this.tblnce === 0) {
